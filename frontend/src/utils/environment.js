export const config = {
    apiUrl: (import.meta.env.VITE_API_URL || "https://medguard-ai-898m.onrender.com").endsWith("/api/v1") 
            ? (import.meta.env.VITE_API_URL || "https://medguard-ai-898m.onrender.com") 
            : `${import.meta.env.VITE_API_URL || "https://medguard-ai-898m.onrender.com"}/api/v1`,
